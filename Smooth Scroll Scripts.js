...
function pageUpBtn() {
    jQuery('.pageup_btn').click(function(){
    ...
    jQuery(window).scroll(function () { 
        if (jQuery(window).scrollTop() > 0) {
            jQuery('.pageup_btn').addClass('show');
        }else {
            jQuery('.pageup_btn').removeClass('show');
        } 
    });
}

function pageUpBtnStopper() {
    jQuery(window).scroll(function() {
       if(jQuery(window).scrollTop() + jQuery(window).height() > jQuery(document).height() - jQuery('footer#footer').height()) {
           jQuery('a.arrow-up').addClass('stop');
       }else{
           jQuery('a.arrow-up').removeClass('stop');
       }
    });
}
