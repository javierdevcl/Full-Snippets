...
function scroll_up_button() {
    jQuery('.scroll_up_btn').click(function(){
    ...
    jQuery(window).scroll(function () { 
        if (jQuery(window).scrollTop() > 0) {
            jQuery('.scroll_up_btn').addClass('show');
        }else {
            jQuery('.scroll_up_btn').removeClass('show');
        } 
    });
}

// scroll up - add class stop before footer
function scroll_up_button() {
    jQuery(window).scroll(function() {
       if(jQuery(window).scrollTop() + jQuery(window).height() > jQuery(document).height() - jQuery('footer#footer').height()) {
           jQuery('.scroll_up_btn').addClass('stop');
       }else{
           jQuery('.scroll_up_btn').removeClass('stop');
       }
    });
}

// add sticky when scrolling
jQuery(window).scroll(function () { 
    if (jQuery(window).scrollTop() > 0) {
